...
//            private NPCMT_TroopCountLimitModel(Config config) => this.config = config;
...
//                            if (count > 0)
//                            {
//                                return Math.Max(count, base.GetHideoutBattlePlayerMaxTroopCount());
//                            }
//                        }
...
//            private static readonly Lazy<TroopCountLimitModel> lazy_instance = new Lazy<TroopCountLimitModel>(() => new NPCMT_TroopCountLimitModel(Config.Instance));
