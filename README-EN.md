...
<td align="left">Remove the attributes of the characters in the player’s army and return them to the available points</td>
</tr>
<tr>
<td align="left">npc.remove_focus [name] | [row] | [column] | [value]</td>
<td align="left">Remove the specialization of the character from the player’s army and return it to the available points</td>
</tr>
<tr>
